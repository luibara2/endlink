...
public class Bedrock_v2168 extends Bedrock_v1001 {
    ...
    public static final BedrockCodec CODEC = Bedrock_v1001.CODEC.toBuilder()
            ...
            // Local addition beyond upstream: completes the trailing build platform BDS omits for a
            // malformed identity. Pairs with the PlayerList repair — see AddPlayerSerializer_v2168.
            .updateSerializer(org.cloudburstmc.protocol.bedrock.packet.AddPlayerPacket.class,
                    AddPlayerSerializer_v2168.INSTANCE)
            ...
            // Local addition beyond upstream: the trailing optional DataSet string. See the
            // serializer's javadoc — it is corroborated by gophertunnel and by a captured packet.
            .updateSerializer(CommandOutputPacket.class, CommandOutputSerializer_v2168.INSTANCE)
