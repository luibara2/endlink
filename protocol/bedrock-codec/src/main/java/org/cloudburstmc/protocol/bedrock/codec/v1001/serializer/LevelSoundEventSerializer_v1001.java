...
public class LevelSoundEventSerializer_v1001 extends LevelSoundEventSerializer_v975 {
    ...
    public void serialize(ByteBuf buffer, BedrockCodecHelper helper, LevelSoundEventPacket packet) {
        // A sound id an older backend codec could not resolve arrives here as null.
        SoundEvent sound = packet.getSound() == null ? SoundEvent.UNDEFINED : packet.getSound();
        helper.writeString(buffer, sound.getSerializeName());
