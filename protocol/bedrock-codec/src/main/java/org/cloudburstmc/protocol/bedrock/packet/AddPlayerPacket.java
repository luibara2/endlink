...
public class AddPlayerPacket implements BedrockPacket, PlayerAbilityHolder {
    ...
    // Kept as a raw int rather than upstream's BuildPlatform enum: every AddPlayer/PlayerList
    // serializer in this tree reads and writes it with readIntLE/writeIntLE, and an unrecognised
    // platform id must round-trip rather than throw.
